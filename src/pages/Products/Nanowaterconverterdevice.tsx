      ...
      <section className="nw-hero">
        ...
        <div className="nw-hero-inner">
          ...
          <div>
            ...
            <span className="nw-flicker">⚡ Scale-Free Industrial Cooling Water Systems</span>

            <p style={{ fontSize:"clamp(14px,1.3vw,16px)", color:"#475569", lineHeight:1.8, marginBottom:12, maxWidth:500 }}>
              An advanced, eco-friendly system designed to{" "}
              <strong style={{ color:"#1e293b" }}>prevent internal scale formation</strong> in industrial cooling water systems.
            </p>
            <p style={{ fontSize:"clamp(14px,1.3vw,16px)", color:"#475569", lineHeight:1.8, marginBottom:24, maxWidth:500 }}>
              <strong style={{ color:"#1e293b" }}>FIT &amp; FORGET technology</strong> — Maintenance free without any chemical dosing. Lifetime efficient with almost negligible operational cost. 
            </p>
