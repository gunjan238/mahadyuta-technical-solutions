...
const css = `
  ...
  .ud-slider {
    ...
    /* Give it enough height to breathe */
    min-height:340px;
  }
...
/* ── Data ── */
const slides = [
  { img: ultrasonic,    make: "SONOTEC · Germany", name: "SONAPHONE III",          desc: "Advanced portable ultrasound device with data recording, analysis and report generation." },
...
/* ══════════════════════════════════════════════════════════
   HERO SLIDER
   — Auto-advances every 3 s, pauses on hover.
   — Prev / next arrows + dot indicators + progress bar.
══════════════════════════════════════════════════════════ */
const INTERVAL = 3000;
...
const HeroSlider = () => {
  ...
  return (
    ...
    >
      ...
      {/* Prev arrow */}
      <button
        className="ud-slider-arrow prev"
        onClick={prev}
      ...
      {/* Next arrow */}
      <button
        className="ud-slider-arrow next"
        onClick={next}
