...
const keyFeatures = [
  { icon: <Wrench size={20} />,   title: "World Class Defect Simulation", desc: "Mechanical & electrical defect simulation facility for hands-on training with real fault conditions." },
  { icon: <Users size={20} />,    title: "Experienced Faculty",           desc: "Highly experienced faculty and trainers with deep industrial reliability expertise." },
  { icon: <Settings size={20} />, title: "Advanced Equipment Access",     desc: "Access to modern and advanced equipment and tools for defect diagnostics." },
  { icon: <Shield size={20} />,   title: "Customised Programs",           desc: "Training programs tailored for both individual professionals and organisational goals." },
];

// ── inline styles for the improved Key Features cards ──────────────────────
    ...
    <div className="tr-page">
      ...
      <section style={{ background:"#fffbeb", padding:"80px 28px" }}>
        <div style={{ maxWidth:1280, margin:"0 auto" }}>
          ...
          {/* Section header */}
          <div ref={refFeatH} className="fu" style={{ textAlign:"center", marginBottom:52 }}>
            <div className="tr-badge" style={{ margin:"0 auto 12px" }}><Shield size={11} /> Key Features</div>
            ...
            <p style={{ fontSize:15, color:"#64748b", maxWidth:480, margin:"0 auto", lineHeight:1.7 }}>
              A purpose-built reliability training centre where industrial expertise meets hands-on practice.
            </p>
          </div>
            ...
            {keyFeatures.map((f, i) => {
              ...
              return (
                <div
                  ...
                  onMouseEnter={e => {
                    e.currentTarget.style.boxShadow = "0 8px 28px rgba(245,158,11,0.15)";
                ...
                >
                  ...
                  <div style={{ display:"flex", alignItems:"center", gap:14 }}>
                    ...
                    <h3 style={{ fontSize:15.5, fontWeight:700, color:"#0f1117", margin:0, lineHeight:1.35 }}>
                      {f.title}
                    </h3>
                  </div>
