...
const sampleSchedule = [
  {
    ...
    topics: [
      ...
      "Equipment failure concepts & P–F curve",
      "Types and objectives of maintenance",
  ...
  },
  {
    ...
    color: "linear-gradient(135deg,#f97316,#dc2626)",
    topics: [
      "Compressed air leak detection principles",
      "Ultrasound fundamentals & airborne applications",
      "Steam trap testing — ultrasound + temperature",
      "Valve pass detection & hydraulic systems",
      "Hands-on: ultrasonic scanning practice",
    ],
  },
  {
    day: "Day 3", theme: "Electrical & Mechanical Diagnostics",
    ...
    topics: [
      ...
      "Infrared thermography — electrical applications",
      "Vibration analysis basics & fault diagnosis",
      "Bearing condition monitoring & lubrication",
      "Hands-on: vibration and thermal tools",
    ],
  },
  {
    day: "Day 4", theme: "Advanced Applications & Data Analysis",
    ...
    topics: [
      ...
      "Case study workshops on real plant data",
      "Oil analysis techniques & sampling",
      "Acoustic imaging technology applications",
    ],
  },
  {
    day: "Day 5", theme: "Reliability Strategy & Assessment",
    ...
    topics: [
      ...
      "Mapping technologies to plant equipment",
      "Real-plant application planning",
      "Final assessment — written & practical",
      "Certificate distribution & graduation",
    ],
  },
];
...
const DayCard = ({
  ...
  <div
    ...
    onMouseEnter={e => {
      e.currentTarget.style.boxShadow = "0 12px 40px rgba(0,0,0,0.11)";
  ...
  >
    ...
    <div style={{
      ...
      <div style={{ minWidth: 0 }}>
        <div style={{
          fontSize: 9.5, fontWeight: 700, color: "rgba(255,255,255,0.70)",
          textTransform: "uppercase", letterSpacing: "0.07em",
        }}>
          {day}
        </div>
        <div style={{ fontSize: 13.5, fontWeight: 700, color: "#fff", lineHeight: 1.3, marginTop: 2 }}>
          {theme}
        </div>
      </div>
    </div>

    {/* Topic list — flex:1 makes this area expand to fill remaining card height */}
    <div style={{
      padding: "16px 16px",
      display: "flex",
      flexDirection: "column",
      ...
      {topics.map((t) => (
        <div key={t} style={{ display: "flex", alignItems: "flex-start", gap: 9 }}>
          ...
          />
          <span style={{ fontSize: 12.5, color: "#475569", lineHeight: 1.55 }}>{t}</span>
        </div>
      ))}
    </div>
  </div>
    ...
    <div className="tr-page">
      ...
      <section className="tr-hero">
        ...
        <div style={{
          ...
          padding: "72px 28px 64px", width: "100%",
        }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 28 }}>
            <Link to="/" style={{ fontSize: 12.5, color: "#64748b", textDecoration: "none" }}>Home</Link>
            <ChevronRight size={12} style={{ color: "#cbd5e1" }} />
          ...
          <h1 style={{
            ...
            color: "#1e293b", lineHeight: 1.06, marginBottom: 16,
          }}>
            5-Day{" "}
            <span style={{
          ...
          <p style={{
            fontSize: "clamp(14px,1.4vw,17px)", color: "#475569",
            lineHeight: 1.75, marginBottom: 16, maxWidth: 580,
          }}>
            <strong style={{ color: "#b45309" }}>Comprehensive Advanced Practical Training</strong> — the deepest
            dive into industrial reliability technologies, combining theory, extensive hands-on practice
            and real-plant case analysis.
          </p>
      ...
      <section style={{ background: "linear-gradient(160deg,#fafaf9 0%,#f0f9ff 100%)", padding: "80px 28px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }} className="tr-two-col">
          <div ref={refHead} className="fu">
            ...
            {highlights.map((h) => (
              <div key={h} style={{
                ...
                background: "#fff", borderRadius: 12, border: "1px solid #eef0f4",
              }}>
                <CheckCircle2 size={15} style={{ color: "#f59e0b", flexShrink: 0, marginTop: 2 }} />
                <span style={{ fontSize: 14, color: "#334155", lineHeight: 1.6 }}>{h}</span>
              </div>
          ...
          <div>
            <div className="tr-badge" style={{ marginBottom: 16 }}>
              <CalendarDays size={11} /> What You Get
            </div>
            <h2 style={{ fontSize: "clamp(22px,3vw,32px)", fontWeight: 700, color: "#0f1117", marginBottom: 20 }}>
              Included in Every Program
            </h2>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              {included.map((item) => (
                <div key={item.title} className="tr-feature" style={{ padding: "16px 18px" }}>
                  <div style={{ fontSize: 13.5, fontWeight: 700, color: "#0f1117", marginBottom: 4 }}>
                    {item.title}
                  </div>
                  <div style={{ fontSize: 12.5, color: "#64748b", lineHeight: 1.55 }}>{item.desc}</div>
                </div>
      ...
      <section style={{ background: "#fffbeb", padding: "80px 28px" }}>
        <div style={{ maxWidth: 1400, margin: "0 auto" }}>
          ...
          {/*
            repeat(5, 1fr)  → all 5 cards in one row, equal width.
            alignItems:stretch (default) → all cells share the tallest card's height.
            DayCard uses height:100% + flex-column so the card fills its cell,
            and flex:1 on the topic list distributes any extra space evenly.
          */}
          <div style={{
            display: "grid",
