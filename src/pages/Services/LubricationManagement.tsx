...
const css = `
  ...
  .lm-flicker { opacity:0; animation:lm-fadein 1.4s cubic-bezier(0.22,1,0.36,1) 0.3s forwards, lm-flicker 4s ease-in-out 2s infinite; font-size:clamp(13px,1.2vw,15px); font-weight:600; background:linear-gradient(90deg,#f59e0b,#ea580c); -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text; display:block; margin-top:10px; margin-bottom:18px; }
