...
const navigation = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Anti-Scaling Devices", path: "/products/scaling-devices" },
      {
        label: "Advanced Thermal Hotspot Monitoring / Solutions",
        path: "/products/thermal-hotspot-monitoring",
      },
      { label: "Industrial Endoscopes", path: "/services/industrial-endoscopy" },
    ],
...
const Header = () => {
  ...
  return (
    <div className="nav-root">
      ...
      >
        ...
        <div
          style={{
            ...
            justifyContent: "space-between",
            padding: "0 32px",
            height: 68,          // ← nav bar row height
          }}
        >
          {/* Logo — increased from 38 → 54 so it fills the bar comfortably */}
          <Link to="/" style={{ display: "flex", alignItems: "center", flexShrink: 0 }}>
      ...
      <div className={`mobile-menu-container lg-hide ${mobileOpen ? "open" : ""}`}>
        <div className="mobile-header">
          {/* Mobile logo — increased from 34 → 46 */}
