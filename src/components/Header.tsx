...
const styles = `
  ...
  .nav-root * { font-family: 'Instrument Sans', sans-serif; box-sizing: border-box; -webkit-font-smoothing: antialiased; }
  ...
  .td-label { font-size: 13.5px; font-weight: 600; color: var(--ink); line-height: 1.3; font-family: 'Syne', sans-serif; }
